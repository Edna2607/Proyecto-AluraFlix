        ...
        try {
            ...
            if (videos) {
                ...
                showAlert({
                    ...
                    icon: "warning",
                    text: 'Se utilizarán datos locales para continuar con la operación. Por favor, ten en cuenta que la información puede no estar completamente actualizada y que los cambios realizados después de esto pueden no ser guardados.',
        ...
        try {
            ...
            if (videos) {
                ...
                showAlert({
                    title: 'Servicio no disponible',
                    icon: "warning",
                    text: ' Se utilizarán datos locales para continuar con la operación. Por favor, ten en cuenta que  los cambios realizados después de esto no serán guardados.',
                    confirmButtonText: 'Aceptar',
                    callback: () => { }
                });
